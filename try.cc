...
Config::SetDefault("ns3::LteUePoweControl::ClosedLoop", BooleanValue(true));
Config::SetDefault("ns3::LteUePoweControl::AccumulationEnabled", BooleanValue(true));
...
lteHelper->SetFadingModelAttribute ("SampleNum", UintegerValue (10000));
...
gridBuildingAllocator->SetAttribute ("NRoomX", UintegerValue (2));
gridBuildingAllocator->SetAttribute ("NRoomY", UintegerValue (4));
gridBuildingAllocator->SetAttribute ("NFloors", UintegerValue (2));
...
mobility.SetPositionAllocator ("ns3::GridBuildingAllocator","MinX", DoubleValue (-350), "MinY", DoubleValue (-200), "DeltaX", DoubleValue (0.0), "DeltaY", DoubleValue (150.0), "GridWidth", UintegerValue (1), "LayoutType", StringValue ("RowFirst"));

 mobility.Install (enbNodes);
BuildingsHelper::Install (enbNodes);
for(uint16_t i=0; i<numberOfNodesEU; i++){
mobility.SetPositionAllocator ("ns3::GridBuildingAllocator","MinX", DoubleValue (-900), "MinY", DoubleValue (-250), "DeltaX", DoubleValue (120.0), "DeltaY", DoubleValue (150.0), "GridWidth", UintegerValue (4), "LayoutType", StringValue ("RowFirst"));

mobility.SetPositionAllocator ("ns3::GridBuildingAllocator","Mode", StringValue ("Time"), "Time", StringValue ("0.5s"), "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=50.0]"), "Bound", RectangleValue (Rectangle(-12000.0, 12000.0, -12000.0, 12000.0)));
}
...
resourceId2 = pAnim->AddResource ("/home/usrp-1/ns3/ns-allinone-3.25/ns-3.25/scratch/phone.png");
